...
const slides = [
  {
    bg: new URL('../assets/images/bg.jpg', import.meta.url).href,
  ...
  {
    bg: new URL('../assets/images/bg1.jpg', import.meta.url).href,
  ...
  {
    bg: new URL('../assets/images/bg3.jpg', import.meta.url).href,
...
const recentActivities = [
  {
    img: new URL('../assets/images/b1.jpg', import.meta.url).href,
    date: 'Dec 22, 2024',
  ...
  {
    img: new URL('../assets/images/b3.jpg', import.meta.url).href,
    date: 'Jan 16-22, 2024',
    title: 'Dental Implant Training/Workshop-Only for Dentist',
  ...
  {
    img: new URL('../assets/images/b6.jpg', import.meta.url).href,
    date: 'Dec 22, 2024',
...
export default function Home() {
  ...
  return (
    <main className="overflow-x-hidden">
      ...
      {/* Features Row */}
      <section id="about" className="py-12 sm:py-14 bg-white dark:bg-gray-900">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            {[
              ...
              <Link 
                to={item.link} 
                key={idx} 
                className="group relative bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-100 dark:border-gray-700 overflow-hidden"
              >
      ...
      {/* Mission & Vision */}
      <section className="py-16 sm:py-20 bg-gradient-to-br from-gray-50 to-blue-50 dark:from-gray-800 dark:to-gray-900">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col lg:flex-row gap-10 lg:gap-16 items-center">
            ...
            <div className="flex-shrink-0 w-full lg:w-96">
              <div className="relative group">
                ...
                <img 
                  src={new URL('../assets/images/sirji.jpg', import.meta.url).href} 
                  alt="Director" 
                ...
                />
                {/* Decorative Elements */}
                <div className="absolute -bottom-4 -right-4 w-24 h-24 bg-blue-500 rounded-full opacity-10 blur-2xl"></div>
                <div className="absolute -top-4 -left-4 w-32 h-32 bg-blue-400 rounded-full opacity-10 blur-2xl"></div>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="flex flex-col lg:flex-row gap-10 lg:gap-16 items-center">
            ...
            <div className="flex-shrink-0 w-full lg:w-96">
              <div className="relative group">
                ...
                <img 
                  src={new URL('../assets/images/ex1.jpg', import.meta.url).href} 
                  alt="Expertise" 
                  className="relative rounded-2xl shadow-2xl w-full h-auto transform group-hover:scale-105 transition-transform duration-500"
                  loading="lazy"
                />
          ...
          <div className="flex flex-col lg:flex-row gap-10 lg:gap-16 items-center">
            <div className="flex-shrink-0 w-full lg:w-96">
              <div className="relative group">
                ...
                <img 
                  src={new URL('../assets/images/ex2.jpg', import.meta.url).href} 
                  alt="Training" 
                  className="relative rounded-2xl shadow-2xl w-full h-auto transform group-hover:scale-105 transition-transform duration-500"
                  loading="lazy"
                />
          ...
          <div className="flex flex-col lg:flex-row gap-10 lg:gap-16 items-center">
            ...
            <div className="flex-shrink-0 w-full lg:w-96">
              <div className="relative group">
                ...
                <img 
                  src={new URL('../assets/images/ex3.jpg', import.meta.url).href} 
                  alt="Global Reach" 
                  className="relative rounded-2xl shadow-2xl w-full h-auto transform group-hover:scale-105 transition-transform duration-500"
                  loading="lazy"
                />
      ...
      {/* Testimonials */}
      <section className="py-20 sm:py-24 bg-gradient-to-br from-gray-50 to-blue-50 dark:from-gray-800 dark:to-gray-900 overflow-hidden">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
            {[
              ...
              <div 
                key={idx} 
                className="group relative bg-white dark:bg-gray-900 p-6 sm:p-8 rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-100 dark:border-gray-700"
              >
                {/* Quote Icon */}
      ...
      <section className="py-20 sm:py-24 bg-white dark:bg-gray-900 border-t border-gray-100 dark:border-gray-800">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            {[
              {
                ...
                img: new URL('../assets/images/b4.jpg', import.meta.url).href,
              ...
              },
              {
                ...
                img: new URL('../assets/images/b5.jpg', import.meta.url).href,
              ...
              },
              {
                ...
                img: new URL('../assets/images/bg3.jpg', import.meta.url).href,
              ...
              },
              {
                ...
                img: new URL('../assets/images/bg2.jpg', import.meta.url).href,
      ...
      <section className="relative py-24 sm:py-32 overflow-hidden">
        ...
        <div className="absolute inset-0">
          <img 
            src={new URL('../assets/images/bg.jpg', import.meta.url).href} 
            alt="Background" 
      ...
      {/* Recent Activities */}
      <section className="py-20 sm:py-24 bg-gradient-to-br from-gray-50 to-blue-50 dark:from-gray-800 dark:to-gray-900">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <span className="inline-block px-4 py-1.5 bg-blue-100 dark:bg-blue-900/40 text-blue-600 dark:text-blue-400 text-sm font-bold rounded-full mb-4">
              Kindway
